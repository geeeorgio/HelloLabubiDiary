import type { FactsObjectListType } from 'src/types';

export const PERSONALITY_FACTS: FactsObjectListType = {
...
export const HABITS_AND_LITTLE_THINGS_FACTS: FactsObjectListType = {
  category: 'Habits & Little Things',
  facts: [
    {
...
export const FEELINGS_EMOTIONS_FACTS: FactsObjectListType = {
...
export const HER_LITTLE_WORLD_FACTS: FactsObjectListType = {
  category: 'Her Little World',
  facts: [
    {
    ...
    {
      id: 'her_little_world_3',
      text: 'Clouds hold unfinished thoughts floating in the sky.',
      isSaved: false,
    },
    {
    ...
    {
      id: 'her_little_world_7',
      text: 'Even shadows feel softer there.',
      isSaved: false,
    },
    {
    ...
    {
      id: 'her_little_world_10',
      text: 'Every ordinary day hides a tiny, invisible miracle.',
      isSaved: false,
    },
  ],
};

export const FactCategoryType = [
  'Personality',
  'Habits & Little Things',
  'Feelings & Emotions',
  'Her Little World',
] as const;
